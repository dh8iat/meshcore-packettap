...
sie gegen historische GRP_TXT-Pakete aus QuestDB kryptografisch bestätigt
werden:
...
APP_VERSION = "0.2"
DEFAULT_QUESTDB_URL = "http://192.168.1.2:9000/"
UPSTREAM_URL = (
...
def main() -> int:
    ...
    ap.add_argument("--questdb-url", default=DEFAULT_QUESTDB_URL)
    ap.add_argument("--upstream-url", default=UPSTREAM_URL)
    ap.add_argument("--project-dir", type=Path, default=Path(__file__).resolve().parent.parent)
    ...
    payloads_by_hash, totals = load_payloads(args.questdb_url, date_from, date_to)
